            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <div class="schedules-content">
                    <table class="table border-bottom">
                        ...
                        <c:forEach items="${planList}" varStatus="planIndex" var="plan">
                            <tr>
                                <td class="col-1">${planIndex.index}</td>
                                <td class="col-2">${plan.name}</td>
                                <td class="col-7">${plan.description}</td>
                                <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                    <a href="/deletePlan?id=${plan.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                                    ...
                                    <a href="/app-edit-schedules.html" class="btn btn-warning rounded-0 text-light m-1">Edytuj</a>
                                        <%-- tutaj linki jeszcze nie działają, to zadania na dalsze kodzenie --%>
                                </td>
                            </tr>
                        </c:forEach>
