    ...
    <div class="row dashboard-nowrap">
        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                    ...
                    <c:forEach items="${recipeList}" varStatus="recipeIndex" var="recipe">
                        <tr class="d-flex">
                            ...
                            <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                                <a href="/deleteRecipe?id=${recipe.id}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                ...
                <font color="red" size="4"><center>${not empty param.msg ? param.msg :  ""}</center></font>
            </div>
        </div>
